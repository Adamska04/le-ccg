export default [
    ...
    },
    {
        ...
        consumeType: "Bronze",
        cardRarity: "Bronze",
        get cardDescription() {return `Eats a bronze unit from your graveyard and boosts its own health.`}
    },
    {
    ...
    },
    {
        ...
        cardRandomness2: 9,
        cardRarity: "Bronze",
        get cardDescription() {return `Boosts self by a random amount between ${this.cardRandomness1} and ${this.cardRandomness2}.`}
    },
    {
    ...
    [{
        ...
        cardEngineTarget: "Random",
        cardTargetUnitType: "Enemy",
        cardEngineCondition: "Allied Unit Damaged",
        cardEngineValue: 0,
        cardRarity: "Silver",
